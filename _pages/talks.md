...
## Invited talks
* {:.pub} **Wright, M. N.** (2025). Tree-based generative modeling and synthetic data. ***Institute for Medical Informatics, Statistics and Epidemiology, Leipzig University***. Leipzig, Germany.
* {:.pub} **Wright, M. N.** (2025). Interpretable Machine Learning. ***Institute of Biostatistics and Clinical Research, University of Münster***. Münster, Germany.
* {:.pub} **Wright, M. N.** (2025). From explainable AI to generative modeling with tree-based machine learning. ***Econometric Institute, Erasmus University Rotterdam***. Rotterdam, Netherlands.
* {:.pub} **Wright, M. N.** (2025). Tree-based generative modeling with applications in explainable AI. ***Department of Statistics, Ludwig-Maximilians-Universität München***. München, Germany.
...
## Tutorials
* {:.pub} **Wright, M. N.** (2025). Introduction to Machine Learning with R and mlr3. ***DAGStat 2025***. Berlin, Germany.
